				...
				<div class="col-md-6">
					...
					<form action="login" method="post">
				  		<div class="form-group">
				    		<label>Email</label>
				    		<input type="email" class="form-control" name="f1"/>
				  		</div>
				 		<div class="form-group">
				    		<label>Password</label>
				    		<input type="password" class="form-control" name="f2"/>
				  		</div>
				  		<div class="text-center">
				  			<button type="submit" class="btn btn-default btnn"><span class="glyphicon glyphicon-log-in"></span>&nbsp;&nbsp;Log In</button>
				  			<a href="forgotpassword" class="btn btn-primary btnn" role="button">Forgot Password?</a>
				  		</div>
					</form>
					<hr/>
